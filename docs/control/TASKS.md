...
LAB-1  결과(Claude 잠정, 2026-08-12) — 조기 종료(EARLY_STOP) 754개 회사 중
       16개가 현재 상장이다(A1a 대조). 15개는 2024~2026년 신규상장 종목이고
       2015~2017 013(상장 전이라 당연) 3연속으로 조기 종료가 걸려, 그 회사가
       실제 존재하는 2024~2025년치를 한 번도 조회하지 않았다. ★ 재수집하면
       채울 수 있는, 작고 특정 가능한 손실이다 — 목록은 결과 문서 참조.
       013이 2015~2017에 몰리는 건 제도 차이가 아니라 스캔 순서(오래된 해부터)
       + 조기종료 규칙의 기계적 결과
LAB-4  결과(Claude 잠정, 2026-08-12) — raw d20 join 표본은 이미 36건으로
       ...
       10월 초·12월 말경(추정). 축 조합이 흔들린 KR 11종목은 07-18 하루의
       일회성 3축→4축 전환뿐 — 그 뒤 23일은 안정적이다. 24일간 종목 이탈 0건
