...
4  ⏳ A3 완료 태그      git tag a3-complete — 이후 비교의 기준점
5  ⏳ A3 회고          30분. 재사용 가능한 수집기 패턴을 추린다 (아래 「회고」)
...
분봉 Collector도 결국 같은 종류의 수집기다. A3가 만든 것을 다음 수집기가 다시
발명하지 않도록 한 페이지로 추린다.
