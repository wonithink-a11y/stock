...
Validated against
  ...
  다음      ★★ autotrader — 2026-09-22 프로필(키·전략·한도·예약)·무한매수 플러그인(옛 러너와 VM 8/8 일치)·웹 조작·
            ...
            nginx 정본은 deploy/nginx-*.conf. 세부: docs/control/세션인수인계-2026-09-26.md(최신 — 알림 VM 이전·미국 8-K·**미국 PIT 수집 체인 분리 실행 중**) · -2026-09-24.md(09-28 국내 모의 1주 시험 예약) · -2026-09-23.md · -2026-09-22-b.md · -2026-09-22.md ·
