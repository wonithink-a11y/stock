...
def main():
    ...
    for ticker in valid_tickers:
        ...
        # Mark as appeared from first_date onwards
    ...
    deployed_per_ticker = shares_series * first_prices_series  # capital per ticker
    ...
    # Before any ticker appears, portfolio value = initial_capital (all cash)
    # This is handled by: before first appearance, position_value=0, remaining_cash=initial_capital
