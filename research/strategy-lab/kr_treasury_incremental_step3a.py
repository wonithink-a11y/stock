#!/usr/bin/env python
"""10-KR-23-24 STEP 3A: TreasuryRatio Incremental Portfolio Test - Top10%.

Tests 3 strategies with Treasury High10% cutoff:
1. LOWMOM60 baseline
2. Treasury Top20% baseline
3. LOWMOM 3-bucket × Treasury High10% (incremental)
"""
import gzip
import json
import os
...
def run_strategy(period_dates, period_qdates, q_idx_map, liq, m, close_by_date,
    ...
    for k, sd in enumerate(period_dates):
        ...
        # Strategy 3: LOWMOM 3-bucket × Treasury High10%
...
def main():
    ...
    strategies = ["LOWMOM60", "Treasury_Top20", "LOWMOM_Treasury_High10"]
    ...
    for strat_name in ["Treasury_Top20", "LOWMOM_Treasury_High10"]:
    ...
    for strat_name in ["LOWMOM_Treasury_High10"]:
    ...
    next_exp = "10-KR-23-24 STEP 3B: Test alternative cutoff"
    if judgment == "YES":
        next_exp = "10-KR-23-24 STEP 3B: Test cutoff sensitivity (Top10% selected)"
    elif judgment == "PARTIAL":
        next_exp = "10-KR-23-24 STEP 3B: Investigate cutoff sensitivity"
    else:
        next_exp = "10-KR-23-24 STEP 3B: Test alternative incremental construction"
