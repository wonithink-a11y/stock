 ...
 *
 * node research/strategy-lab/slot_marginal_analysis_window6.js
 *
 * 접근 (production 무수정):
 ...
 *
 * 출력: research/strategy-lab/findings/slot-marginal-contribution-window6/snapshots.json
 *
 * (window6 변형: SD5D_WINDOW=20 — 수급 트렌드를 20거래일 창으로 측정)
 */
'use strict';
const fs = require('fs');
...
function main() {
  ...
  const outDir = path.join(ROOT, 'research', 'strategy-lab', 'findings', 'slot-marginal-contribution-window6');
