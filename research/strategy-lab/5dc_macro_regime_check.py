...
무변경, 새 회귀 없음 - 순수 진단.
  ...
  python 5dc_macro_regime_check.py
"""
import json
import os
import sys
...
def main():
    ...
    out = {
        ...
        "context": "5DC-v1A-P의 macro regime 축별 조건부 성과 검증 - "
    ...
    out_dir = os.path.join(REPO_ROOT, "research", "strategy-lab", "reports",
                           "2026-08-24-5dc-macro-regime")
    os.makedirs(out_dir, exist_ok=True)
    out_path = os.path.join(out_dir, "5dc-v1a-p-macro-regime-check.json")
